...
from app.crud.category import get_all_category,get_category
from app.crud.product import get_product_cat, get_random_product,get_product,get_all_product
...
#product page
@router.get('/user_product/{product_id}')
